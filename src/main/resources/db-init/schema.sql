...
VALUES
-- ACTIVE (15)
(nextval('LOGIN_USER_SEQ'), 'foos', '$2a$10$examplehash', 'foos@example.com', 'Lucas', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '10 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'janedoe', '$2a$10$examplehash', 'janedoe@example.com', 'Jane', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'johnsmith', '$2a$10$examplehash', 'johnsmith@example.com', 'John', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '12 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'alicew', '$2a$10$examplehash', 'alicew@example.com', 'Alice', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '15 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'bobm', '$2a$10$examplehash', 'bobm@example.com', 'Bob', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '1 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'charliec', '$2a$10$examplehash', 'charliec@example.com', 'Charlie', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '8 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'davidk', '$2a$10$examplehash', 'davidk@example.com', 'David', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '7 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'evea', '$2a$10$examplehash', 'evea@example.com', 'Eve', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '3 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'frankb', '$2a$10$examplehash', 'frankb@example.com', 'Frank', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '6 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'graceh', '$2a$10$examplehash', 'graceh@example.com', 'Grace', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '4 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'henryv', '$2a$10$examplehash', 'henryv@example.com', 'Henry', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '9 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'isabellac', '$2a$10$examplehash', 'isabellac@example.com', 'Isabella', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '11 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'jackr', '$2a$10$examplehash', 'jackr@example.com', 'Jack', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '14 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'karenp', '$2a$10$examplehash', 'karenp@example.com', 'Karen', 'ACTIVE', CURRENT_TIMESTAMP - INTERVAL '13 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- PENDING (15)
(nextval('LOGIN_USER_SEQ'), 'larryl', '$2a$10$examplehash', 'larryl@example.com', 'Larry', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '18 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'monicah', '$2a$10$examplehash', 'monicah@example.com', 'Monica', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '20 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'nathanp', '$2a$10$examplehash', 'nathanp@example.com', 'Nathan', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '22 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'oliviam', '$2a$10$examplehash', 'oliviam@example.com', 'Olivia', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '25 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'paulw', '$2a$10$examplehash', 'paulw@example.com', 'Paul', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '19 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'quinnf', '$2a$10$examplehash', 'quinnf@example.com', 'Quinn', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '17 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'rachelr', '$2a$10$examplehash', 'rachelr@example.com', 'Rachel', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '16 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'stevenk', '$2a$10$examplehash', 'stevenk@example.com', 'Steven', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '21 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'tinaf', '$2a$10$examplehash', 'tinaf@example.com', 'Tina', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '23 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(nextval('LOGIN_USER_SEQ'), 'ursulae', '$2a$10$examplehash', 'ursulae@example.com', 'Ursula', 'PENDING', CURRENT_TIMESTAMP - INTERVAL '24 days', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
